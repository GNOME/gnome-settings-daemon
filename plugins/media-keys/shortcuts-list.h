...
static struct {
        ...
        { VOLUME_DOWN_KEY, NULL, NULL, "<Ctrl>XF86AudioLowerVolume", SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        { VOLUME_UP_KEY, "volume-up", NULL, NULL, SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        { VOLUME_UP_KEY, NULL, NULL, "<Ctrl>XF86AudioRaiseVolume", SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        ...
        { PLAY_KEY, NULL, NULL, "<Ctrl>XF86AudioPlay", SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        ...
        { PREVIOUS_KEY, NULL, NULL, "<Ctrl>XF86AudioPrev", SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        { NEXT_KEY, "next", NULL, NULL, SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
        { NEXT_KEY, NULL, NULL, "<Ctrl>XF86AudioNext", SHELL_ACTION_MODE_ALL, META_KEY_BINDING_NONE },
