...
static struct {
        ...
        { MUTE_QUIET_KEY, "quiet-volume-mute", NULL, NULL, SHELL_ACTION_MODE_ALL },
        { VOLUME_DOWN_QUIET_KEY,  "quiet-volume-down", NULL, NULL, SHELL_ACTION_MODE_ALL },
        { VOLUME_UP_QUIET_KEY,  "quiet-volume-up", NULL, NULL, SHELL_ACTION_MODE_ALL },
        { VOLUME_DOWN_PRECISE_KEY,  "precise-volume-down", NULL, NULL, SHELL_ACTION_MODE_ALL },
        { VOLUME_UP_PRECISE_KEY,  "precise-volume-up", NULL, NULL, SHELL_ACTION_MODE_ALL },
