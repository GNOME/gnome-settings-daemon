...
#define GNOME_XSETTINGS_ALL_LEVELS (GNOME_XSETTINGS_LEVEL_STARTUP | GNOME_XSETTINGS_LEVEL_CONFIGURATION | GNOME_XSETTINGS_LEVEL_LOGIN_WINDOW | GNOME_XSETTINGS_LEVEL_HOST_CHOOSER | GNOME_XSETTINGS_LEVEL_REMOTE_HOST | GNOME_XSETTINGS_LEVEL_SHUTDOWN)
