...
void
gsd_identity_manager_get_identity (GsdIdentityManager   *self,
                                   const char           *identifier,
                                   GCancellable         *cancellable,
                                   GAsyncReadyCallback   callback,
                                   gpointer              user_data)
{
        GSD_IDENTITY_MANAGER_GET_IFACE (self)->get_identity (self,
                                                             identifier,
                                                             cancellable,
                                                             callback,
                                                             user_data);
...
GsdIdentity *
gsd_identity_manager_get_identity_finish (GsdIdentityManager   *self,
                                          GAsyncResult         *result,
                                          GError              **error)
{
        return GSD_IDENTITY_MANAGER_GET_IFACE (self)->get_identity_finish (self, result, error);
}
