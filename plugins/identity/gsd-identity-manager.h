...
struct _GsdIdentityManagerInterface
{
        ...
        /* Virtual Functions */
        void      (* get_identity)         (GsdIdentityManager   *identity_manager,
                                              const char           *identifier,
                                              GCancellable         *cancellable,
                                              GAsyncReadyCallback   callback,
                                              gpointer              user_data);
        GsdIdentity * (* get_identity_finish)  (GsdIdentityManager  *identity_manager,
                                                GAsyncResult        *result,
                                                GError             **error);
...
void       gsd_identity_manager_get_identity (GsdIdentityManager   *identity_manager,
                                              const char           *identifier,
                                              GCancellable         *cancellable,
                                              GAsyncReadyCallback   callback,
                                              gpointer              user_data);
GsdIdentity *gsd_identity_manager_get_identity_finish (GsdIdentityManager   *identity_manager,
                                                       GAsyncResult         *result,
                                                       GError              **error);
