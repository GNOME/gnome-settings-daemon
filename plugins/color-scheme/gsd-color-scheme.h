...
gdouble             gsd_color_scheme_get_sunrise         (GsdColorScheme *self);
gdouble             gsd_color_scheme_get_sunset          (GsdColorScheme *self);

/* Testing Function */
void                gsd_color_scheme_set_date_time_now   (GsdColorScheme *self,
                                                          GDateTime      *datetime);
