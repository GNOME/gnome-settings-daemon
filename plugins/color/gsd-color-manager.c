...
color_recheck_cb (gpointer user_data)
{
        ...
        gsd_location_monitor_recheck (manager->monitor);
...
gsd_color_manager_init (GsdColorManager *manager)
{
        ...
        manager->monitor = gsd_location_monitor_new ();
        ...
        manager->nlight = gsd_night_light_new (manager->monitor);
        ...
        manager->color_scheme = gsd_color_scheme_new (manager->monitor);
