...
MMObject *gsd_wwan_device_get_mm_object (GsdWwanDevice *device);
MMModem  *gsd_wwan_device_get_mm_modem  (GsdWwanDevice *device);
MMSim    *gsd_wwan_device_get_mm_sim    (GsdWwanDevice *device);
