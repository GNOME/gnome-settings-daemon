                                    ...
                                    GError **error)
{
        ...
        retval = g_dbus_proxy_call_sync (manager->mutter_displayconfig_proxy,
...
external_monitor_is_connected (GsdPowerManager *manager)
{
        ...
        state = g_dbus_proxy_call_sync (manager->mutter_displayconfig_proxy,
                                        "GetCurrentState",
                                        NULL,
                                        G_DBUS_CALL_FLAGS_NONE,
                                        -1,
                                     ...
                                     gpointer user_data)
{
        ...
        manager->mutter_displayconfig_proxy = g_dbus_proxy_new_for_bus_finish (res, &error);

        if (manager->mutter_displayconfig_proxy == NULL) {
